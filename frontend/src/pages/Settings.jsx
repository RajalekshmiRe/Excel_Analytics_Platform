...
const Settings = ({ currentUser, theme, setTheme }) => {
  ...
  return (
    <div className={`min-h-screen ${bgColor} p-4 md:p-8 lg:p-12`}>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className={`${cardBg} rounded-3xl shadow-xl p-8 border-2 ${borderColor}`}>
          <h1 className={`text-4xl lg:text-5xl font-bold mb-3 flex items-center gap-3 ${textColor}`}>
            Settings <Shield className="text-[#bc4e9c]" size={40} />
          </h1>
          <p className="text-gray-600 text-lg">
            Manage your account preferences and security
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Profile Card */}
          <div className="lg:col-span-1">
            <div className={`${cardBg} rounded-3xl shadow-xl p-8 border-2 ${borderColor} text-center hover:shadow-2xl transition-all`}>
              <div className="relative inline-block mb-6">
                <div className={`w-32 h-32 bg-gradient-to-t ${accentGradient} rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-lg`}>
                  {initials}
                </div>
                <div className="absolute -bottom-2 -right-2 h-8 w-8 bg-green-500 border-4 border-white rounded-full"></div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Profile Information */}
            <div className={`${cardBg} rounded-3xl shadow-xl p-8 border-2 ${borderColor} hover:shadow-2xl transition-all`}>
              <h2 className={`text-2xl font-bold mb-6 flex items-center gap-3 ${textColor}`}>
                <User className="text-[#bc4e9c]" size={28} />
                Profile Information
              </h2>
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleInputChange}
                    className={`w-full px-6 py-4 rounded-xl border-2 border-gray-300 bg-white ${textColor} focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent`}
                    placeholder="Enter your full name"
                  />
                </div>
                <div>
                ...
                <button
                  onClick={handleSaveProfile}
                  disabled={loading}
                  className={`w-full bg-gradient-to-r ${accentGradient} text-white px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all font-bold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed`}
                >
                  <Save size={20} />
                  {loading ? "Saving..." : "Save Profile Changes"}
                </button>
            ...
            <div className={`${cardBg} rounded-3xl shadow-xl p-8 border-2 ${borderColor} hover:shadow-2xl transition-all`}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={key}
                    className="flex items-center justify-between p-6 bg-gray-50 rounded-xl border-2 border-gray-200 hover:bg-gray-100 hover:border-gray-300 transition-all"
                  >
                    <div className="flex-1">
                      <h3 className={`font-bold text-lg mb-1 ${textColor}`}>{label}</h3>
                      <p className="text-sm text-gray-600">{desc}</p>
                    </div>
                    <button
                      onClick={() => handleNotificationChange(key)}
              ...
              <button
                onClick={handleSaveNotifications}
                className={`w-full mt-6 bg-gradient-to-r ${accentGradient} text-white px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all font-bold flex items-center justify-center gap-2`}
              >
                <Save size={20} />
                Save Notification Preferences
              </button>

      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden border border-gray-100">
        <div className="p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">Start analyzing your data today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            <div>
              <label className="block text-base font-semibold text-gray-900 mb-3">Full Name</label>
              <input
                type="text"
                name="name"
            ...
            <div>
              <label className="block text-base font-semibold text-gray-900 mb-3">Email Address</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="block text-base font-semibold text-gray-900 mb-3">Password</label>
          ...
          <div className="mt-10 text-center border-t border-gray-200 pt-8">
            <p className="text-gray-700 text-base">
              ...
              <Link to="/login" className="text-blue-600 hover:text-cyan-700 font-bold underline">
                Login
              </Link>
            </p>
          </div>

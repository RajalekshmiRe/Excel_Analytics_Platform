...
export default function Reports() {
  ...
  const fetchReportData = async () => {
    try {
      ...
      const [statsRes, chartsRes, usersRes, filesRes, activityRes] = await Promise.all([
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Reports & Analytics</h1>
              <p className="text-gray-600 mt-1">Excel Analytics Platform - System Reports</p>
            </div>
            <div className="flex gap-3">
              <select
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <p className="text-sm text-blue-600 mt-2">{stats?.activeUsers || 0} active in last 7 days</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <p className="text-sm text-green-600 mt-2">{stats?.successfulUploads || 0} successful</p>
              </div>

              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-semibold text-gray-600 uppercase">Storage Used</h3>
                  <svg className="w-8 h-8 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" />
                  </svg>
                </div>
                <p className="text-3xl font-bold text-gray-900">{stats?.totalStorage || 0} GB</p>
                <p className="text-sm text-gray-500 mt-2">Total storage consumed</p>
              </div>

              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm font-semibold text-gray-600 uppercase">Charts Generated</h3>
                  <svg className="w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <p className="text-3xl font-bold text-gray-900">{stats?.chartsGenerated || 0}</p>
                <p className="text-sm text-orange-600 mt-2">Visualizations created</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center justify-center">
                  <div className="relative w-32 h-32">
                    <svg className="w-32 h-32 transform -rotate-90">
                      <circle cx="64" cy="64" r="52" stroke="#E5E7EB" strokeWidth="12" fill="none" />
                      <circle 
                        cx="64" 
                        cy="64" 
                        r="52" 
                        ...
                        strokeWidth="12" 
                        fill="none"
                        strokeDasharray={`${(stats?.systemHealth || 0) * 3.27} 327`}
                      />
                    </svg>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-2xl font-bold text-gray-900">{stats?.systemHealth || 0}%</span>
                    </div>
                  </div>
                </div>
                <p className="text-center text-sm text-gray-600 mt-4">Uptime: {stats?.uptime || 'N/A'}</p>
              </div>

              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Reports Status</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <span className="text-sm font-medium text-gray-700">Completed</span>
                    <span className="text-lg font-bold text-green-600">{stats?.completedReports || 0}</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <span className="text-sm font-medium text-gray-700">Pending</span>
                    <span className="text-lg font-bold text-yellow-600">{stats?.pendingReports || 0}</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <span className="text-sm font-medium text-gray-700">Failed</span>
                    <span className="text-lg font-bold text-red-600">{stats?.failedUploads || 0}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Total API requests</p>
                </div>
              </div>
            </div>
          </>
        ...
        {activeTab === 'users' && (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">User Management Report</h2>
              <button
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{user.uploads}</td>
        ...
        {activeTab === 'files' && (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">File Upload Report</h2>
              <button
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {files.map((file) => (
                    <tr key={file.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{file.userName}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
        ...
        {activeTab === 'charts' && chartData && (
          <>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Upload Trend */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">Upload Trend</h2>
              ...
              {/* File Formats */}
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-6">File Format Distribution</h2>
                <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold">{stats?.chartsGenerated || 0}</p>

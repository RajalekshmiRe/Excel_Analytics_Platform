        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage uploaded Excel and data files</p>
            </div>
            <button
              onClick={fetchFiles}
              ...
              <tbody>
                {filteredFiles.length === 0 ? (
                    ...
                    <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                      <div className="flex flex-col items-center">
                        <svg className="w-16 h-16 text-gray-300 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h6.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
                        </svg>
                  ...
                  filteredFiles.map((file, index) => (
                    <tr key={file.id || index} className={index % 2 === 0 ? 'bg-white hover:bg-gray-50' : 'bg-gray-50 hover:bg-gray-100'}>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <span className="text-2xl">{getFileTypeIcon(file.fileName)}</span>
                          <div>
                            <p className="font-semibold text-gray-900">{file.fileName || 'Unnamed File'}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 text-gray-700">{file.userName || 'Unknown User'}</td>
                      <td className="px-6 py-4 text-gray-700 font-medium">{file.size || '0 KB'}</td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            title="View Details"
                            onClick={() => alert(`File: ${file.fileName}\nUploader: ${file.userName}\nSize: ${file.size}`)}
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
